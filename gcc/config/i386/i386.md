...
(define_expand "move_guard_to_reg"
  [(match_operand 0 "register_operand")
   (match_operand 1 "memory_operand")]
  "!TARGET_HAS_BIONIC"
{
  ...
  operands[1] = GEN_INT (TARGET_THREAD_SSP_OFFSET);
  insn = (TARGET_LP64
	  ? gen_move_tls_guard_to_reg_di
	  : gen_move_tls_guard_to_reg_si);
#else
  insn = (TARGET_LP64
	  ? gen_move_guard_to_reg_di
	  : gen_move_guard_to_reg_si);
#endif
...
(define_insn "move_guard_to_reg_<mode>"
...
(define_insn "move_tls_guard_to_reg_<mode>"
  [(set (match_operand:PTR 0 "register_operand" "=r")
	(unspec:PTR [(match_operand:PTR 1 "const_int_operand" "i")]
		    UNSPEC_SP_TLS_GET))]
  ""
  "mov{<imodesuffix>}\t{%@:%P1, %0|%0, <iptrsize> PTR %@:%P1}"
  [(set_attr "type" "multi")])
;; TODO type = multi?

;;(define_expand "fp_protect_add"
;;  [(match_operand 0 "memory_operand")
;;   (match_operand 1 "memory_operand")
;;   (match_operand 2)]
;;  "!TARGET_HAS_BIONIC"
...
;;  operands[1] = GEN_INT (TARGET_THREAD_SSP_OFFSET);
;;  insn = (TARGET_LP64
;;	  ? gen_fp_tls_protect_add_di
;;	  : gen_fp_tls_protect_add_si);
;;#else
;;  insn = (TARGET_LP64
;;	  ? gen_fp_protect_add_di
;;	  : gen_fp_protect_add_si);
;;#endif
;;
;;  emit_insn (insn (operands[0], operands[1]));
;;  DONE;
;;})
;;
;;(define_insn "fp_protect_add_<mode>"
;;  [(set (match_operand:PTR 0 "memory_operand" "=m")
;;	(unspec:PTR [(match_operand:PTR 1 "memory_operand" "m")]
;;		    UNSPEC_FPG_ADD))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
;;   (set (match_scratch:PTR 3 "=&r") (const_int 0))
;;   (clobber (reg:CC FLAGS_REG))]
;;  "!TARGET_HAS_BIONIC"
;;  "mov{<imodesuffix>}\t{%0, %2|%2, %0}\;mov{<imodesuffix>}\t{%1, %3|%3, %1}\;xor{<imodesuffix>}\t{%3, %2|%2, %3}\;sub{<imodesuffix>}\t{%3, %2|%2, %3}\;mov{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2\;xor{l}\t%k3, %k3"
;;  [(set_attr "type" "multi")])
;;
;;(define_insn "fp_tls_protect_add_<mode>"
;;  [(set (match_operand:PTR 0 "memory_operand" "=m")
;;	(unspec:PTR [(match_operand:PTR 1 "const_int_operand" "i")]
;;		    UNSPEC_FPG_TLS_ADD))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
...
;;   (clobber (reg:CC FLAGS_REG))]
;;  ""
;;  "mov{<imodesuffix>}\t{%0, %2|%2, %0}\;mov{<imodesuffix>}\t{%@:%P1, %3|%3, <iptrsize> PTR %@:%P1}\;xor{<imodesuffix>}\t{%3, %2|%2, %3}\;sub{<imodesuffix>}\t{%3, %2|%2, %3}\;mov{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2\;xor{l}\t%k3, %k3"
;;  [(set_attr "type" "multi")])
;;
;;(define_expand "fp_protect_rm"
;;  [(match_operand 0 "register_operand")
;;   (match_operand 1 "memory_operand")]
;;  "!TARGET_HAS_BIONIC"
;;{
...
;;  operands[1] = GEN_INT (TARGET_THREAD_SSP_OFFSET);
;;  insn = (TARGET_LP64
;;	  ? gen_fp_tls_protect_rm_di
;;	  : gen_fp_tls_protect_rm_si);
;;#else
;;  insn = (TARGET_LP64
;;	  ? gen_fp_protect_rm_di
;;	  : gen_fp_protect_rm_si);
;;#endif
;;
;;  emit_insn (insn (operands[0], operands[1]));
;;  DONE;
;;})
;;
;;(define_insn "fp_protect_rm_<mode>"
;;  [(set (match_operand:PTR 0 "register_operand" "=r")
;;	(unspec:PTR [(match_operand:PTR 1 "memory_operand" "m")]
;;		    UNSPEC_FPG_RM))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
;;   (clobber (reg:CC FLAGS_REG))]
;;  "!TARGET_HAS_BIONIC"
;;  "mov{<imodesuffix>}\t{%1, %2|%2, %1}\;add{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2"
;;  [(set_attr "type" "multi")])
;;
;;(define_insn "fp_tls_protect_rm_<mode>"
;;  [(set (match_operand:PTR 0 "register_operand" "=r")
;;	(unspec:PTR [(match_operand:PTR 1 "const_int_operand" "i")]
;;		    UNSPEC_FPG_TLS_RM))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
;;   (clobber (reg:CC FLAGS_REG))]
;;  ""
;;  "mov{<imodesuffix>}\t{%@:%P1, %2|%2, <iptrsize> PTR %@:%P1}\;add{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2"
;;  [(set_attr "type" "multi")])
;;
;;(define_expand "fp_protect_rm_mem"
;;  [(match_operand 0 "memory_operand")
;;   (match_operand 1 "memory_operand")]
;;  "!TARGET_HAS_BIONIC"
;;{
...
;;  operands[1] = GEN_INT (TARGET_THREAD_SSP_OFFSET);
;;  insn = (TARGET_LP64
;;	  ? gen_fp_tls_protect_rm_mem_di
;;	  : gen_fp_tls_protect_rm_mem_si);
;;#else
;;  insn = (TARGET_LP64
;;	  ? gen_fp_protect_rm_mem_di
;;	  : gen_fp_protect_rm_mem_si);
;;#endif
;;
;;  emit_insn (insn (operands[0], operands[1]));
;;  DONE;
;;})
;;
;;(define_insn "fp_protect_rm_mem_<mode>"
;;  [(set (match_operand:PTR 0 "memory_operand" "=m")
;;	(unspec:PTR [(match_operand:PTR 1 "memory_operand" "m")]
;;		    UNSPEC_FPG_RM_MEM))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
...
;;   (clobber (reg:CC FLAGS_REG))]
;;  "!TARGET_HAS_BIONIC"
;;  "mov{<imodesuffix>}\t{%0, %2|%2, %0}\;mov{<imodesuffix>}\t{%1, %3|%3, %1}\;add{<imodesuffix>}\t{%3, %2|%2, %3}\;xor{<imodesuffix>}\t{%3, %2|%2, %3}\;mov{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2\;xor{l}\t%k3, %k3"
;;  [(set_attr "type" "multi")])
;;
;;(define_insn "fp_tls_protect_rm_mem_<mode>"
;;  [(set (match_operand:PTR 0 "memory_operand" "=m")
;;	(unspec:PTR [(match_operand:PTR 1 "const_int_operand" "i")]
;;		    UNSPEC_FPG_TLS_RM_MEM))
;;   (set (match_scratch:PTR 2 "=&r") (const_int 0))
...
;;   (clobber (reg:CC FLAGS_REG))]
;;  ""
;;  "mov{<imodesuffix>}\t{%0, %2|%2, %0}\;mov{<imodesuffix>}\t{%@:%P1, %3|%3, <iptrsize> PTR %@:%P1}\;add{<imodesuffix>}\t{%3, %2|%2, %3}\;xor{<imodesuffix>}\t{%3, %2|%2, %3}\;mov{<imodesuffix>}\t{%2, %0|%0, %2}\;xor{l}\t%k2, %k2\;xor{l}\t%k3, %k3"
;;  [(set_attr "type" "multi")])
